...
CREATE TABLE HMS_HOSPITAL_BRANCH_MD (
    ...
    CONSTRAINT FK_BRANCH_MASTER_MD    FOREIGN KEY (HOSPITAL_CODE)
...
CREATE TABLE HMS_DEPARTMENT_MD (
    ...
    CONSTRAINT PK_HMS_DEPARTMENT_MD    PRIMARY KEY (DEPARTMENT_ID),
    CONSTRAINT FK_DEPT_BRANCH_MD       FOREIGN KEY (HOSPITAL_ID)
                                    REFERENCES HMS_HOSPITAL_BRANCH_MD (HOSPITAL_ID),
    CONSTRAINT CHK_BEDS_POSITIVE_MD    CHECK (NUMBER_OF_BEDS >= 0)
);
...
COMMENT ON COLUMN HMS_DEPARTMENT_MD.DEPARTMENT_NAME     IS 'Descriptive name of the department (e.g., Kidney, Critical Care)';
...
CREATE TABLE HMS_EMPLOYEES_MD (
    ...
    CONSTRAINT PK_HMS_EMPLOYEES_MD    PRIMARY KEY (EMPLOYEE_ID),
    CONSTRAINT FK_EMP_BRANCH_MD       FOREIGN KEY (HOSPITAL_ID)
                                   REFERENCES HMS_HOSPITAL_BRANCH_MD (HOSPITAL_ID),
    CONSTRAINT FK_EMP_DEPT_MD         FOREIGN KEY (DEPARTMENT_ID)
...
CREATE TABLE HMS_EMPLOYEE_PHONE_MST_MD (
    ...
    CONSTRAINT PK_EMP_PHONE_MD     PRIMARY KEY (PHONE_RECORD_ID),
    CONSTRAINT FK_PHONE_EMP_MD     FOREIGN KEY (EMPLOYEE_ID)
...
CREATE TABLE HMS_DOCTOR_AVAILABILITY_MD (
    ...
    CONSTRAINT FK_AVAIL_DOCTOR_MD     FOREIGN KEY (DOCTOR_ID)
                                   REFERENCES HMS_EMPLOYEES_MD (EMPLOYEE_ID),
    CONSTRAINT FK_AVAIL_DEPT_MD       FOREIGN KEY (DOCTOR_DEPARTMENT)
                                   REFERENCES HMS_DEPARTMENT_MD (DEPARTMENT_ID),
    CONSTRAINT CHK_AVAIL_DAY_MD       CHECK (AVAILABILITY_DAY IN (
...
CREATE TABLE HMS_PATIENT_MD (
    ...
    CONSTRAINT FK_PATIENT_BRANCH_MD    FOREIGN KEY (HOSPITAL_ID)
                                    REFERENCES HMS_HOSPITAL_BRANCH_MD (HOSPITAL_ID),
    CONSTRAINT FK_PATIENT_DEPT_MD      FOREIGN KEY (DEPARTMENT_ID)
                                    REFERENCES HMS_DEPARTMENT_MD (DEPARTMENT_ID)
);
...
-- ===========================================================
CREATE SEQUENCE HMS_HOSPITAL_BRANCH_SEQ_MD  START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE HMS_DEPARTMENT_SEQ_MD       START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE HMS_EMPLOYEES_SEQ_MD        START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE HMS_EMP_PHONE_SEQ_MD        START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE HMS_DOC_AVAIL_SEQ_MD        START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE HMS_PATIENT_SEQ_MD          START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE HMS_PAT_PHONE_SEQ_MD        START WITH 1 INCREMENT BY 1 NOCACHE;
...
-- ===========================================================
CREATE OR REPLACE VIEW HMS_HOSP_BRANCH_V_MD AS 
SELECT HOSPITAL_ID, BRANCH_NAME FROM HMS_HOSPITAL_BRANCH_MD;

CREATE OR REPLACE VIEW HMS_DEPARTMENT_V_MD AS 
SELECT DEPARTMENT_ID, DEPARTMENT_NAME FROM HMS_DEPARTMENT_MD;

-- END OF FILE: HMS_CREATE_TABLES_MD.sql
-- ============================================================
