...
* **Value Set Name:** `HMS_HOSPITAL_LOV_CH`
...
* Click **Edit Information**:
  * **Table Name:** `HMS_HOSPITAL_BRANCH_CH`
...
* **Value Set Name:** `HMS_DEPT_LOV_CH`
...
* **Value Set Name:** `HMS_DEPT_DEP_LOV_CH`
...
* Click **Edit Information**:
  ...
  * **Where / Order By:** `WHERE HOSPITAL_ID = :$FLEX$.HMS_HOSPITAL_LOV_CH`
...
|-----------------|------------|------------------|---------------------|-------------|
| `HMS_EMP_EXEC_CH` | `HMS_EMP_EXEC_CH` | **Oracle Reports** | `HMS_EMP_DEPT_REPORT_CH` | `Executable for HMS Employee Dept Report` |
| `HMS_LOAD_EXEC_CH`| `HMS_LOAD_EXEC_CH`| **PL/SQL Stored Procedure** | `HMS_PKG_CH.LOAD_STAGING_TO_BASE` | `Executable for Loading Staging Data to Base` |
| `HMS_SUMM_EXEC_CH`| `HMS_SUMM_EXEC_CH`| **PL/SQL Stored Procedure** | `HMS_PKG_CH.GET_BRANCH_SUMMARY` | `Executable for Fetching Branch Summary` |
| `HMS_LIST_EXEC_CH`| `HMS_LIST_EXEC_CH`| **PL/SQL Stored Procedure** | `HMS_PKG_CH.GET_EMPLOYEES_LIST` | `Executable for Fetching Employees List` |
| `HMS_DPAT_EXEC_CH`| `HMS_DPAT_EXEC_CH`| **PL/SQL Stored Procedure** | `HMS_PKG_CH.GET_DEPT_PATIENTS` | `Executable for Fetching Department Patients` |
...
* **Program:** `HMS Emp Dept Report CH` / **Short Name:** `HMS_EMP_PROG_CH`
* **Description:** `HMS Employee Department Report for CH`
* **Executable Name:** `HMS_EMP_EXEC_CH` (Format: PDF)
* **Style:** `A4` *(Mandatory for standard Oracle PDF report layouts)*
* **Parameters:**
  * Seq `10` | Parameter: `P_DEPARTMENT` | Description: `Select Department` | Value Set: `HMS_DEPT_LOV_CH` | Token: `P_DEPARTMENT` | Required: Yes

**2. Load Staging to Base (Data Loading)**
* **Program:** `HMS Load Staging Data CH` / **Short Name:** `HMS_LOAD_PROG_CH`
* **Description:** `Concurrent Program to bulk load validated staging data to base tables`
* **Executable Name:** `HMS_LOAD_EXEC_CH`

**3. Get Branch Summary**
* **Program:** `HMS Branch Summary CH` / **Short Name:** `HMS_SUMM_PROG_CH`
* **Description:** `Concurrent Program to analyze hospital branch totals`
* **Executable Name:** `HMS_SUMM_EXEC_CH` (Format: Text)
* **Parameters:**
  * Seq `10` | Parameter: `P_HOSPITAL_ID` | Description: `Select Hospital Branch` | Value Set: `HMS_HOSPITAL_LOV_CH` | Token: `P_HOSPITAL_ID`

**4. Get Employees List**
* **Program:** `HMS Employees List CH` / **Short Name:** `HMS_LIST_PROG_CH`
* **Description:** `Concurrent Program to retrieve structured employee lists`
* **Executable Name:** `HMS_LIST_EXEC_CH` (Format: Text)
* **Parameters:**
  * Seq `10` | Parameter: `P_HOSPITAL_ID` | Description: `Select Hospital Branch` | Value Set: `HMS_HOSPITAL_LOV_CH` | Token: `P_HOSPITAL_ID`

**5. Get Dept Patients**
* **Program:** `HMS Dept Patients CH` / **Short Name:** `HMS_DPAT_PROG_CH`
* **Description:** `Concurrent Program to track admitted patients per department`
* **Executable Name:** `HMS_DPAT_EXEC_CH` (Format: Text)
* **Parameters:**
  * Seq `10` | Parameter: `P_HOSPITAL_ID` | Description: `Select Hospital Branch` | Value Set: `HMS_HOSPITAL_LOV_CH` | Token: `P_HOSPITAL_ID`
  * Seq `20` | Parameter: `P_DEPARTMENT_ID` | Description: `Select Department` | Value Set: `HMS_DEPT_DEP_LOV_CH` | Token: `P_DEPARTMENT_ID`
...
* **Group Name:** `HMS_REQ_GROUP_CH`
* **Application:** `Application Object Library`
* **Code:** *(Leave blank as it is not mandated)*
* **Description:** `Request group containing all HMS analytical reports and staging data loaders for CH`
* **Requests Table (Add these 5):**
  * Type: `Program` | Name: `HMS Emp Dept Report CH`
  * Type: `Program` | Name: `HMS Load Staging Data CH`
  * Type: `Program` | Name: `HMS Branch Summary CH`
  * Type: `Program` | Name: `HMS Employees List CH`
  * Type: `Program` | Name: `HMS Dept Patients CH`
* -> **Save**
...
|---------------|--------------------|------|------|
| `HMS_PAT_FORM_CH` | `HMS Patient Form CH` | `FORM` | *(Pick ANY Form from LOV)* |
| `HMS_EMP_FORM_CH` | `HMS Employee Form CH` | `FORM` | *(Pick ANY Form from LOV)* |
| `HMS_EMP_RPT_CH` | `HMS Run Emp Report CH` | `FORM` | *(Pick ANY Form from LOV)* |
...
* **Menu:** `HMS_FORMS_SUBMENU_CH`
* **User Menu Name:** `HMS Forms SubMenu CH`
...
* **Menu:** `HMS_MAIN_MENU_CH`
* **User Menu Name:** `HMS Main Menu CH`
...
* **Responsibility Name:** `HMS Responsibility CH`
* **Application:** `Application Object Library`
* **Responsibility Key:** `HMS_RESP_CH`
* **Description:** `Primary Responsibility for HMS Data Entry, Analysis, and Reporting operations for CH`
...
* **Menu:** `HMS_MAIN_MENU_CH`
* **Request Group:** `HMS_REQ_GROUP_CH`
* -> **Save**
...
* **User Name:** `HMS_USER_CH`
* **Password:** *(any password)*
* **Responsibilities Tab (bottom):** Add `HMS Responsibility CH`
* -> **Save**
...
**1. Log into your new user** (`HMS_USER_CH`).
**2. Select `HMS Responsibility CH`** from the Navigator.
...
**4. Test Data Loading (The Concurrent Request):**
   ...
   * Select `HMS Load Staging Data CH`
...
**5. Test Your 3 Analytical Procedures:**
   ...
   * Select `HMS Branch Summary CH`. A perfect LOV Dropdown will appear asking for the Hospital ID! Select a hospital and Submit.
