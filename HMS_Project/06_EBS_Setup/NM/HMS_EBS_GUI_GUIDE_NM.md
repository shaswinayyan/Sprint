...
* **Value Set Name:** `HMS_HOSPITAL_LOV_NM`
...
* Click **Edit Information**:
  * **Table Name:** `HMS_HOSPITAL_BRANCH_NM`
...
* **Value Set Name:** `HMS_DEPT_LOV_NM`
...
* **Value Set Name:** `HMS_DEPT_DEP_LOV_NM`
...
* Click **Edit Information**:
  ...
  * **Where / Order By:** `WHERE HOSPITAL_ID = :$FLEX$.HMS_HOSPITAL_LOV_NM`
...
|-----------------|------------|------------------|---------------------|-------------|
| `HMS_EMP_EXEC_NM` | `HMS_EMP_EXEC_NM` | **Oracle Reports** | `HMS_EMP_DEPT_REPORT_NM` | `Executable for HMS Employee Dept Report` |
| `HMS_LOAD_EXEC_NM`| `HMS_LOAD_EXEC_NM`| **PL/SQL Stored Procedure** | `HMS_PKG_NM.LOAD_STAGING_TO_BASE` | `Executable for Loading Staging Data to Base` |
| `HMS_SUMM_EXEC_NM`| `HMS_SUMM_EXEC_NM`| **PL/SQL Stored Procedure** | `HMS_PKG_NM.GET_BRANCH_SUMMARY` | `Executable for Fetching Branch Summary` |
| `HMS_LIST_EXEC_NM`| `HMS_LIST_EXEC_NM`| **PL/SQL Stored Procedure** | `HMS_PKG_NM.GET_EMPLOYEES_LIST` | `Executable for Fetching Employees List` |
| `HMS_DPAT_EXEC_NM`| `HMS_DPAT_EXEC_NM`| **PL/SQL Stored Procedure** | `HMS_PKG_NM.GET_DEPT_PATIENTS` | `Executable for Fetching Department Patients` |
...
* **Program:** `HMS Emp Dept Report NM` / **Short Name:** `HMS_EMP_PROG_NM`
* **Description:** `HMS Employee Department Report for NM`
* **Executable Name:** `HMS_EMP_EXEC_NM` (Format: PDF)
* **Style:** `A4` *(Mandatory for standard Oracle PDF report layouts)*
* **Parameters:**
  * Seq `10` | Parameter: `P_DEPARTMENT` | Description: `Select Department` | Value Set: `HMS_DEPT_LOV_NM` | Token: `P_DEPARTMENT` | Required: Yes

**2. Load Staging to Base (Data Loading)**
* **Program:** `HMS Load Staging Data NM` / **Short Name:** `HMS_LOAD_PROG_NM`
* **Description:** `Concurrent Program to bulk load validated staging data to base tables`
* **Executable Name:** `HMS_LOAD_EXEC_NM`

**3. Get Branch Summary**
* **Program:** `HMS Branch Summary NM` / **Short Name:** `HMS_SUMM_PROG_NM`
* **Description:** `Concurrent Program to analyze hospital branch totals`
* **Executable Name:** `HMS_SUMM_EXEC_NM` (Format: Text)
* **Parameters:**
  * Seq `10` | Parameter: `P_HOSPITAL_ID` | Description: `Select Hospital Branch` | Value Set: `HMS_HOSPITAL_LOV_NM` | Token: `P_HOSPITAL_ID`

**4. Get Employees List**
* **Program:** `HMS Employees List NM` / **Short Name:** `HMS_LIST_PROG_NM`
* **Description:** `Concurrent Program to retrieve structured employee lists`
* **Executable Name:** `HMS_LIST_EXEC_NM` (Format: Text)
* **Parameters:**
  * Seq `10` | Parameter: `P_HOSPITAL_ID` | Description: `Select Hospital Branch` | Value Set: `HMS_HOSPITAL_LOV_NM` | Token: `P_HOSPITAL_ID`

**5. Get Dept Patients**
* **Program:** `HMS Dept Patients NM` / **Short Name:** `HMS_DPAT_PROG_NM`
* **Description:** `Concurrent Program to track admitted patients per department`
* **Executable Name:** `HMS_DPAT_EXEC_NM` (Format: Text)
* **Parameters:**
  * Seq `10` | Parameter: `P_HOSPITAL_ID` | Description: `Select Hospital Branch` | Value Set: `HMS_HOSPITAL_LOV_NM` | Token: `P_HOSPITAL_ID`
  * Seq `20` | Parameter: `P_DEPARTMENT_ID` | Description: `Select Department` | Value Set: `HMS_DEPT_DEP_LOV_NM` | Token: `P_DEPARTMENT_ID`
...
* **Group Name:** `HMS_REQ_GROUP_NM`
* **Application:** `Application Object Library`
* **Code:** *(Leave blank as it is not mandated)*
* **Description:** `Request group containing all HMS analytical reports and staging data loaders for NM`
* **Requests Table (Add these 5):**
  * Type: `Program` | Name: `HMS Emp Dept Report NM`
  * Type: `Program` | Name: `HMS Load Staging Data NM`
  * Type: `Program` | Name: `HMS Branch Summary NM`
  * Type: `Program` | Name: `HMS Employees List NM`
  * Type: `Program` | Name: `HMS Dept Patients NM`
* -> **Save**
...
|---------------|--------------------|------|------|
| `HMS_PAT_FORM_NM` | `HMS Patient Form NM` | `FORM` | *(Pick ANY Form from LOV)* |
| `HMS_EMP_FORM_NM` | `HMS Employee Form NM` | `FORM` | *(Pick ANY Form from LOV)* |
| `HMS_EMP_RPT_NM` | `HMS Run Emp Report NM` | `FORM` | *(Pick ANY Form from LOV)* |
...
* **Menu:** `HMS_FORMS_SUBMENU_NM`
* **User Menu Name:** `HMS Forms SubMenu NM`
...
* **Entries (leave Submenu blank here since we are assigning Functions):**
  * Seq `10` | Prompt `Manage Patients` | Function `HMS_PAT_FORM_NM` | Description `Opens the Patient Management Form`
  * Seq `20` | Prompt `Manage Employees` | Function `HMS_EMP_FORM_NM` | Description `Opens the Employee Management Form`
  * Seq `30` | Prompt `Run Employee Report` | Function `HMS_EMP_RPT_NM` | Description `Submits the Employee Department Report`
* -> **Save**
...
* **Menu:** `HMS_MAIN_MENU_NM`
* **User Menu Name:** `HMS Main Menu NM`
...
* **Entries (leave Function blank and assign the Sub-Menu you just created):**
  * Seq `10` | Prompt `Hospital Data Entry Forms` | Submenu `HMS_FORMS_SUBMENU_NM` | Description `Navigates into the Data Entry and Execution Sub-Menu`
...
* **Responsibility Name:** `HMS Responsibility NM`
* **Application:** `Application Object Library`
* **Responsibility Key:** `HMS_RESP_NM`
* **Description:** `Primary Responsibility for HMS Data Entry, Analysis, and Reporting operations for NM`
...
* **Menu:** `HMS_MAIN_MENU_NM`
* **Request Group:** `HMS_REQ_GROUP_NM`
* -> **Save**
...
* **User Name:** `HMS_USER_NM`
* **Password:** *(any password)*
* **Responsibilities Tab (bottom):** Add `HMS Responsibility NM`
* -> **Save**
...
**1. Log into your new user** (`HMS_USER_NM`).
**2. Select `HMS Responsibility NM`** from the Navigator.
...
**4. Test Data Loading (The Concurrent Request):**
   ...
   * Select `HMS Load Staging Data NM`
...
**5. Test Your 3 Analytical Procedures:**
   ...
   * Select `HMS Branch Summary NM`. A perfect LOV Dropdown will appear asking for the Hospital ID! Select a hospital and Submit.
