...
* **Value Set Name:** `HMS_HOSPITAL_LOV_SH`
...
* Click **Edit Information**:
  * **Table Name:** `HMS_HOSPITAL_BRANCH_SH`
...
* **Value Set Name:** `HMS_DEPT_LOV_SH`
...
* **Value Set Name:** `HMS_DEPT_DEP_LOV_SH`
...
* Click **Edit Information**:
  ...
  * **Where / Order By:** `WHERE HOSPITAL_ID = :$FLEX$.HMS_HOSPITAL_LOV_SH`
...
|-----------------|------------|------------------|---------------------|-------------|
| `HMS_EMP_EXEC_SH` | `HMS_EMP_EXEC_SH` | **Oracle Reports** | `HMS_EMP_DEPT_REPORT_SH` | `Executable for HMS Employee Dept Report` |
| `HMS_LOAD_EXEC_SH`| `HMS_LOAD_EXEC_SH`| **PL/SQL Stored Procedure** | `HMS_PKG_SH.LOAD_STAGING_TO_BASE` | `Executable for Loading Staging Data to Base` |
| `HMS_SUMM_EXEC_SH`| `HMS_SUMM_EXEC_SH`| **PL/SQL Stored Procedure** | `HMS_PKG_SH.GET_BRANCH_SUMMARY` | `Executable for Fetching Branch Summary` |
| `HMS_LIST_EXEC_SH`| `HMS_LIST_EXEC_SH`| **PL/SQL Stored Procedure** | `HMS_PKG_SH.GET_EMPLOYEES_LIST` | `Executable for Fetching Employees List` |
| `HMS_DPAT_EXEC_SH`| `HMS_DPAT_EXEC_SH`| **PL/SQL Stored Procedure** | `HMS_PKG_SH.GET_DEPT_PATIENTS` | `Executable for Fetching Department Patients` |
...
* **Program:** `HMS Emp Dept Report SH` / **Short Name:** `HMS_EMP_PROG_SH`
* **Description:** `HMS Employee Department Report for SH`
* **Executable Name:** `HMS_EMP_EXEC_SH` (Format: PDF)
* **Style:** `A4` *(Mandatory for standard Oracle PDF report layouts)*
* **Parameters:**
  * Seq `10` | Parameter: `P_DEPARTMENT` | Description: `Select Department` | Value Set: `HMS_DEPT_LOV_SH` | Token: `P_DEPARTMENT` | Required: Yes

**2. Load Staging to Base (Data Loading)**
* **Program:** `HMS Load Staging Data SH` / **Short Name:** `HMS_LOAD_PROG_SH`
* **Description:** `Concurrent Program to bulk load validated staging data to base tables`
* **Executable Name:** `HMS_LOAD_EXEC_SH`

**3. Get Branch Summary**
* **Program:** `HMS Branch Summary SH` / **Short Name:** `HMS_SUMM_PROG_SH`
* **Description:** `Concurrent Program to analyze hospital branch totals`
* **Executable Name:** `HMS_SUMM_EXEC_SH` (Format: Text)
* **Parameters:**
  * Seq `10` | Parameter: `P_HOSPITAL_ID` | Description: `Select Hospital Branch` | Value Set: `HMS_HOSPITAL_LOV_SH` | Token: `P_HOSPITAL_ID`

**4. Get Employees List**
* **Program:** `HMS Employees List SH` / **Short Name:** `HMS_LIST_PROG_SH`
* **Description:** `Concurrent Program to retrieve structured employee lists`
* **Executable Name:** `HMS_LIST_EXEC_SH` (Format: Text)
* **Parameters:**
  * Seq `10` | Parameter: `P_HOSPITAL_ID` | Description: `Select Hospital Branch` | Value Set: `HMS_HOSPITAL_LOV_SH` | Token: `P_HOSPITAL_ID`

**5. Get Dept Patients**
* **Program:** `HMS Dept Patients SH` / **Short Name:** `HMS_DPAT_PROG_SH`
* **Description:** `Concurrent Program to track admitted patients per department`
* **Executable Name:** `HMS_DPAT_EXEC_SH` (Format: Text)
* **Parameters:**
  * Seq `10` | Parameter: `P_HOSPITAL_ID` | Description: `Select Hospital Branch` | Value Set: `HMS_HOSPITAL_LOV_SH` | Token: `P_HOSPITAL_ID`
  * Seq `20` | Parameter: `P_DEPARTMENT_ID` | Description: `Select Department` | Value Set: `HMS_DEPT_DEP_LOV_SH` | Token: `P_DEPARTMENT_ID`
...
* **Group Name:** `HMS_REQ_GROUP_SH`
* **Application:** `Application Object Library`
* **Code:** *(Leave blank as it is not mandated)*
* **Description:** `Request group containing all HMS analytical reports and staging data loaders for SH`
* **Requests Table (Add these 5):**
  * Type: `Program` | Name: `HMS Emp Dept Report SH`
  * Type: `Program` | Name: `HMS Load Staging Data SH`
  * Type: `Program` | Name: `HMS Branch Summary SH`
  * Type: `Program` | Name: `HMS Employees List SH`
  * Type: `Program` | Name: `HMS Dept Patients SH`
* -> **Save**
...
|---------------|--------------------|------|------|
| `HMS_PAT_FORM_SH` | `HMS Patient Form SH` | `FORM` | *(Pick ANY Form from LOV)* |
| `HMS_EMP_FORM_SH` | `HMS Employee Form SH` | `FORM` | *(Pick ANY Form from LOV)* |
| `HMS_EMP_RPT_SH` | `HMS Run Emp Report SH` | `FORM` | *(Pick ANY Form from LOV)* |
...
* **Menu:** `HMS_FORMS_SUBMENU_SH`
* **User Menu Name:** `HMS Forms SubMenu SH`
...
* **Entries (leave Submenu blank here since we are assigning Functions):**
  * Seq `10` | Prompt `Manage Patients` | Function `HMS_PAT_FORM_SH` | Description `Opens the Patient Management Form`
  * Seq `20` | Prompt `Manage Employees` | Function `HMS_EMP_FORM_SH` | Description `Opens the Employee Management Form`
  * Seq `30` | Prompt `Run Employee Report` | Function `HMS_EMP_RPT_SH` | Description `Submits the Employee Department Report`
* -> **Save**
...
* **Menu:** `HMS_MAIN_MENU_SH`
* **User Menu Name:** `HMS Main Menu SH`
...
* **Responsibility Name:** `HMS Responsibility SH`
* **Application:** `Application Object Library`
* **Responsibility Key:** `HMS_RESP_SH`
* **Description:** `Primary Responsibility for HMS Data Entry, Analysis, and Reporting operations for SH`
...
* **Menu:** `HMS_MAIN_MENU_SH`
* **Request Group:** `HMS_REQ_GROUP_SH`
* -> **Save**
...
* **User Name:** `HMS_USER_SH`
* **Password:** *(any password)*
* **Responsibilities Tab (bottom):** Add `HMS Responsibility SH`
* -> **Save**
...
**1. Log into your new user** (`HMS_USER_SH`).
**2. Select `HMS Responsibility SH`** from the Navigator.
...
**4. Test Data Loading (The Concurrent Request):**
   ...
   * Select `HMS Load Staging Data SH`
...
**5. Test Your 3 Analytical Procedures:**
   ...
   * Select `HMS Branch Summary SH`. A perfect LOV Dropdown will appear asking for the Hospital ID! Select a hospital and Submit.
